...
O usuário com Função de *Instituição Admin* pode criar uma **Estrutura Geotécnica** preenchendo todos os campos obrigatórios do formulário (@figu-criar-estrutura).
