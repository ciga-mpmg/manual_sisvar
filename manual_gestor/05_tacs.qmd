...
A tela TACs exibe uma lista dos TACs relacionados à auditoria do *Gestor*, organizados em ordem alfabética. Nesta tela, é possível gerenciar os TACs, incluindo pesquisa e edição de TACs, além da exibição para o envio e validação de planilhas-modelo (@figu-tela06).
...
O usuário *Gestor* pode submeter e validar planilhas-modelo (@figu-submissoes). 
...
Nesta aba, o usuário *Gestor* pode visualizar os nomes alternativos do TAC (quando houver) ou criar um **Nome Alternativo**. Também é possível definir um nome alternativo como principal (@figu-nomes).
