...
## Enviar convite
O usuário com perfil de *Instituição Admin* pode clicar no botão **Novo convite** e enviar o convite preenchendo os campos obrigatórios do formulário (@figu-convite). Todas as opções de Função estão disponíveis para esse usuário.
